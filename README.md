...
The remit of the assignment was to create a responsive website of around 4-5 pages, or, if using a single scrolling page, a website with clearly defined page areas. In doing this, the use of semantic HTML5 elements were necessary to structure the HTML code appropriately. In addition, the site should make use of CSS frameworks and a wireframe provided the foundation of the page structure prior to development.
